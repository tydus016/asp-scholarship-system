...
namespace WebApplication1.Controllers
{
    public class CebuCityController : Controller
    {
        ...
        public async Task<IActionResult> SubmitApplication(IFormFile file, int free_tuition_fee, int subsidized, int special, string firstname, string lastname, string middlename, string elementary, string junior, string senior, string mother, string father, string address, string dob, string pob, string contact_no, string email, int bmp, int ccs, int dole, string school_year)
        {
            var stats = 0;
            try
            {
                ...
                var filesEntity = new Applicants()
                {
                    ...
                    ccs = ccs,
                    dole = dole,
                    free_tuition_fee = free_tuition_fee,
